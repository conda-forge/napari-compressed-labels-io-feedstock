About napari-compressed-labels-io-feedstock
===========================================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/napari-compressed-labels-io-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15224&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/napari-compressed-labels-io-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `napari-compressed-labels-io` can be installed with `conda`:
...
```
mamba install napari-compressed-labels-io
```

It is possible to list all of the versions of `napari-compressed-labels-io` available on your platform with `conda`:
...
```
mamba search napari-compressed-labels-io --channel conda-forge
```
...
mamba repoquery search napari-compressed-labels-io --channel conda-forge

# List packages depending on `napari-compressed-labels-io`:
mamba repoquery whoneeds napari-compressed-labels-io --channel conda-forge

# List dependencies of `napari-compressed-labels-io`:
mamba repoquery depends napari-compressed-labels-io --channel conda-forge
```
